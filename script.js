...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const routes = {
        ...
        '/cranes': './Cranes/Index.html',
        '/equipment': './Equipment/equipment.html',
        '/equipment-clientele': './Equipment_Clientele/equipment_clientele.html',
        '/message': '../Message-From-MD/message-from-md.html',
        '/project': './Project/project.html',
        '/transportation': './Transportation/transportation.html',
        '/warehousing': './Warehousing/real-estate.html',
        '/broker': './Broker/broker.html'
    };
    ...
    function handleRoute() {
        ...
        if (routes[normalizedPath]) {
            ...
            if (path !== routes[normalizedPath]) {
                window.location.href = routes[normalizedPath];
            }
        }
    }
    
    // Add click handlers to links with data attributes
    document.addEventListener('click', function(e) {
        // Find the closest element with data-route attribute (including the element itself)
    ...
    // Update your existing navigation code to use clean URLs
    const navLinks = document.querySelectorAll('.nav-link');
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            const targetId = this.getAttribute('href');
            
            // Check if the link is for a clean route
            if (Object.keys(routes).includes(targetId)) {
                e.preventDefault();
                window.location.href = routes[targetId];
            }
        });
    });

    // Smooth scrolling for navigation links
    const navLinksOrig = document.querySelectorAll('.nav-link');
    navLinksOrig.forEach(link => {
        link.addEventListener('click', function(e) {
            const targetId = this.getAttribute('href');
    ...
    serviceCards.forEach(card => {
        card.addEventListener('click', function(e) {
            // Check if the click was on the overlay or learn-more text
            const target = e.target;
            if (!target.classList.contains('service-overlay') && !target.classList.contains('learn-more')) {
                // Only proceed if clicked on the card but not on overlay elements
                e.preventDefault();
                e.stopPropagation();
                ...
                // Find the data-route attribute on this card
